...
<head>
    ...
    <script src="/scripts/js/masks.js?v=10.2.9"></script>
    ...
    <link rel="stylesheet" href="/modules/forms/public/assets/styles.css?v=10.2.9">
...
<?php if (!empty($customization['logo'])): ?>
    ...
    <!-- Scripts -->
    <script src="/modules/forms/public/assets/scripts.js?v=10.2.9"></script>
