...
<body class="min-h-screen flex flex-col"
      ...
      data-offer-loading1="<?= htmlspecialchars($customization['offer_loading_text_1'] ?? 'Analisando seu perfil...') ?>"
      data-offer-loading2="<?= htmlspecialchars($customization['offer_loading_text_2'] ?? 'Procurando a melhor oferta...') ?>"
      data-offer-title="<?= htmlspecialchars($customization['offer_title'] ?? '') ?>"
      data-offer-description="<?= htmlspecialchars($customization['offer_description'] ?? '') ?>"
      data-offer-anchor-price="<?= $customization['offer_anchor_price'] ?? '' ?>"
      data-offer-promo-price="<?= $customization['offer_promo_price'] ?? '' ?>"
      data-offer-scarcity="<?= htmlspecialchars($customization['offer_scarcity_text'] ?? '') ?>"
