...
<head>
  ...
  <link rel="stylesheet" href="/scripts/css/global.css?v=7.4">

  <!-- Scripts globais (ORDEM CORRETA) -->
  <script src="/scripts/js/global/theme.js?v=7.4"></script>
  <script src="/scripts/js/global/ui.js?v=7.4"></script>
  <script src="/scripts/js/global/modals.js?v=7.4"></script>
  <script src="/scripts/js/global/helpers.js?v=7.4"></script>

  <!-- Script de formulários (DEPOIS dos globais) -->
  <script src="/modules/forms/assets/admin.js?v=7.4"></script>
