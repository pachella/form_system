...
<head>
  ...
  <link rel="stylesheet" href="/scripts/css/global.css?v=11.0.2">

  <!-- Scripts globais (ORDEM CORRETA) -->
  <script src="/scripts/js/global/theme.js?v=11.0.2"></script>
  <script src="/scripts/js/global/ui.js?v=11.0.2"></script>
  <script src="/scripts/js/global/modals.js?v=11.0.2"></script>
  <script src="/scripts/js/global/helpers.js?v=11.0.2"></script>
  ...
  <script src="/assets/js/pro-features.js?v=11.0.2"></script>

  <!-- Script de formulários (DEPOIS dos globais) -->
  <script src="/modules/forms/assets/admin.js?v=11.0.2"></script>
